 ...
 * @author mcomas
 */
public class testTernaryPlotPredictiveRegion3d {
    public static void main(String args[]) {
        ...
        /*Ternary3dObject ellipsoid2 = new Ternary3dSurfaceObject(display,
                PlotUtils.predictiveRegion3d(transData, 0.95));
        ellipsoid2.setColor(new Color(150, 230, 150));
        display.addCoDaObject(ellipsoid2);*/

        Ternary3dObject ellipsoid3 = new Ternary3dSurfaceObject(display,
                PlotUtils.predictiveRegion3d(transData, 0.99));
