 ...
 * @author mcomas
 */
public class Biplot2dWindow extends RealPlot2dWindow{
    private Biplot2dDisplay biplot;
    SingularValueDecomposition svd;
    
    JSlider biplotType;
    JTextField gammaField;
    
    public Biplot2dWindow(DataFrame dataframe, Biplot2dDisplay display, String title, SingularValueDecomposition s){
        ...
        biplotType.addChangeListener(new ChangeListener(){
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                double GH[][][] = CoDaStats.biplot(svd, 2, gamma);
