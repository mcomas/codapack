 ...
 * @author mcomas
 */
public class VariousLogcontrasts {
...
*/
    ...
    public static void main(String args[]){
        ...
        var[0] = 0.0006; // Per logcontrast unitari.
        var[1] = 0.0006;
        ...
        main.setVisible(true);
            ...
            TernaryPlotWindow frame = new TernaryPlotWindow(
                        df, new TernaryPlotBuilder(names, generatedData).build(), "TEST");
