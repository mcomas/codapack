...
public class ImportMenu extends JDialog {
    ...
    public ImportMenu(final CoDaPackMain mainApp, boolean modal) {
        super(mainApp, modal);
    ...
    public ImportMenu(java.awt.Frame parent, boolean modal,
            JFileChooser chooseFile) {
        super(parent, modal);

        Point p = parent.getLocation();
        p.x = p.x + (parent.getWidth()-520)/2;
        p.y = p.y + (parent.getHeight()-430)/2;
        setLocation(p);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Data Frame Name:");

        spreadsheet1.setBorder(javax.swing.BorderFactory.createTitledBorder("Spreadsheet options"));

        jLabel3.setText("Start reading at row:");

        jLabel4.setText("Non-available data:");

        jLabel5.setText("Prefix for non-detected data:");
