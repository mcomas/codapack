 ...
 * @author mcomas
 */
public final class DataSelector2NumOCatNumOCat extends JPanel {
    ...
    public DataSelector2NumOCatNumOCat(DataFrame dataFrame){
        initComponents();
        df_instance = dataFrame;
        if(dataFrame != null)
            this.setDataLists(dataFrame, null);
    }
    public DataSelector2NumOCatNumOCat(DataFrame dataFrame, boolean groups, boolean all) {
        initComponents();
    ...
    public DataSelector2NumOCatNumOCat(DataFrame dataFrame, int[]selected, boolean groups) {
        initComponents();
        groupsComboBox.setVisible(groups);
        labGroups.setVisible(groups);
        df_instance = dataFrame;
    ...
    public DataSelector2NumOCatNumOCat(DataFrame dataFrame, boolean groups) {
        initComponents();
        groupsComboBox.setVisible(groups);
        labGroups.setVisible(groups);
        df_instance = dataFrame;
    ...
    public DataSelector2NumOCatNumOCat(DataFrame activeDataFrame, int[] selectedData, String categoric) {
        initComponents();
