 ...
 * @author Guest2
 */
public abstract class AbstractMenuDialog2NumCatONumWithILR extends AbstractMenuDialog2NumCatONum{
    ...
    JRadioButton part;
    JRadioButton base;
    public AbstractMenuDialog2NumCatONumWithILR(CoDaPackMain main, String text, boolean groups, boolean allowEmpty, boolean categoric){
