...
public class AtypMenu extends AbstractMenuDialog{
    ...
    void showGraphics(){
        ...
        this.framesAtypMenu = new JFrame[numberOfGraphics];
    ...
    private void plotAtypMenu(int position) {
            ...
            WindowListener exitListener = new WindowAdapter(){
                ...
                public void windowClosing(WindowEvent e){
                    ...
                    if(confirm == 0){
                        framesAtypMenu[position].dispose();
            ...
            framesAtypMenu[position].setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
            framesAtypMenu[position].addWindowListener(exitListener);
            framesAtypMenu[position].setVisible(true);
    }
