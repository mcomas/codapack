 ...
 */
public abstract class AbstractMenuDialogSDL extends JDialog {
    ...
    public AbstractMenuDialogSDL(final CoDaPackMain mainApp, String title, boolean groups, JFileChooser chooseFile, ImportRDA impdf) throws ScriptException {
        super(mainApp, title);
        mainApplication = mainApp;
        ds = null;
        imp_df = impdf;
    ...
    public AbstractMenuDialogSDL(final CoDaPackMain mainApp, String title, boolean groups, boolean allowEmpty){
        super(mainApp, title);
        mainApplication = mainApp;
        dfs = null;
    ...
    public AbstractMenuDialogSDL(final CoDaPackMain mainApp, String title, boolean groups){
        super(mainApp, title);
        mainApplication = mainApp;
        dfs = null;
        ds = new DataSelector(mainApplication.getActiveDataFrame(), CoDaPackMain.dataList.getSelectedData(), groups);
    ...
    private void initialize(){
        ...
        optionsPanel.setPreferredSize(new Dimension(400,400));
