 ...
 * @author mcomas
 */
public abstract class AbstractMenuDialog2NumCat extends JDialog{
    final DataSelector2NumCat ds;
    ...
    int WIDTH = 650;//560;
    int HEIGHT = 500;//430;
    public AbstractMenuDialog2NumCat(final CoDaPackMain mainApp, String title, boolean groups, boolean allowEmpty, boolean categoric){
        super(mainApp, title);
        mainApplication = mainApp;

        dfs = null;
        ds = new DataSelector2NumCat(mainApplication.getActiveDataFrame(), groups, categoric);
        initialize();
    }
    public AbstractMenuDialog2NumCat(final CoDaPackMain mainApp, String title, boolean groups, JFileChooser chooseFile, ImportRDA impdf) throws ScriptException{
        super(mainApp, title);
        mainApplication = mainApp;
        ds = null;
        imp_df = impdf;
    ...
    public AbstractMenuDialog2NumCat(final CoDaPackMain mainApp, String title, boolean groups, boolean allowEmpty){
        super(mainApp, title);
        mainApplication = mainApp;
        dfs = null;
        this.allowEmpty = allowEmpty;
        ds = new DataSelector2NumCat(mainApplication.getActiveDataFrame(), CoDaPackMain.dataList.getSelectedData(), groups);
        initialize();
    }
    public AbstractMenuDialog2NumCat(final CoDaPackMain mainApp, String title, boolean groups){
        super(mainApp, title);
        mainApplication = mainApp;
        dfs = null;
        ds = new DataSelector2NumCat(mainApplication.getActiveDataFrame(), CoDaPackMain.dataList.getSelectedData(), groups);
    ...
    public AbstractMenuDialog2NumCat(final CoDaPackMain mainApp, String title, String categoric){
        super(mainApp, title);
        mainApplication = mainApp;
        dfs = null;
        ds = new DataSelector2NumCat(mainApplication.getActiveDataFrame(), CoDaPackMain.dataList.getSelectedData(), categoric);
        initialize();
    }
    ...
    public DataSelector2NumCat getDataSelector(){
        return ds;
    }
