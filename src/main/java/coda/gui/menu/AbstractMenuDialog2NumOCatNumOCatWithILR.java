 ...
 * @author Guest2
 */
public abstract class AbstractMenuDialog2NumOCatNumOCatWithILR extends AbstractMenuDialog2NumOCatNumOCat{
    ...
    JRadioButton part;
    JRadioButton base;
    public AbstractMenuDialog2NumOCatNumOCatWithILR(CoDaPackMain main, String text, boolean groups, boolean allowEmpty, boolean categoric){
