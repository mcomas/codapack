 ...
 * @author marc
 */
public abstract class AbstractCoDaDisplayFX extends Canvas{
    ...
    protected FXGraphics2D g2;
    public AbstractCoDaDisplayFX(){
        this.g2 = new FXGraphics2D(getGraphicsContext2D());
        widthProperty().addListener(e -> paintComponent(getWidth(), getHeight())); 
        heightProperty().addListener(e -> paintComponent(getWidth(), getHeight())); 
        //setOpaque(true);
