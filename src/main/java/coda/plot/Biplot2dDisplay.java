 ...
 * @author mcomas
 */
public class Biplot2dDisplay extends RealPlot2dDisplay{
    ...
    public static class Biplot2dBuilder extends RealPlot2dBuilder{
        ...
        public Biplot2dBuilder(String names[], double tG[][], double tH[][]){
            super(names, tG);
            dataComponent = tH;
        }
        
        @Override
        public Biplot2dBuilder groups(int groups[], String[] gnames){
            return (Biplot2dBuilder) super.groups(groups, gnames);
        }
        @Override
        public Biplot2dBuilder mapping(int mapping[]){
            return (Biplot2dBuilder) super.mapping(mapping);
        }
        @Override
        public Biplot2dDisplay build(){
            return new Biplot2dDisplay(this);
        }
    }
    public Biplot2dDisplay(Biplot2dBuilder builder){
        super(builder);
        ...
        Z = new double[oriZ[0].length][2];
        H = new double[oriH.length][2];
...
//            decomposition = new TeXFormula(formula).
    ...
    public void transformData(){
        ...
        for(int i=0;i<H.length;i++){
            H[i] = transform(oriH[i][0], oriH[i][1], H[i]);
        }
    }
...
//        decomposition.paintIcon(null, g2, getWidth()-200, getHeight()-50);
    ...
    public void drawVectors(Graphics2D g2){
        ...
        double sep[][] = new double[H.length][2];
        for(int i=0;i<H.length;i++){
