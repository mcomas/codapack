 ...
 * @author mcomas
 */
public class testTernaryPlotPredictiveRegion {
    public static void main(String args[]) {
        ...
        Ternary2dObject curveObject2 = new Ternary2dCurveObject(display,
                    PlotUtils.predictiveRegion2d(transData, 0.95));
            curveObject2.setColor(Color.black);//new Color(70, 100, 70));
            display.addCoDaObject(curveObject2);

        Ternary2dObject curveObject3 = new Ternary2dCurveObject(display,
                PlotUtils.predictiveRegion2d(transData, 0.90));
            curveObject3.setColor(Color.black);//new Color(70, 100, 70));
            display.addCoDaObject(curveObject3);

        Ternary2dObject curveObject4 = new Ternary2dCurveObject(display,
                PlotUtils.predictiveRegion2d(transData, 0.99));
            curveObject4.setColor(Color.black);//new Color(70, 100, 70));
